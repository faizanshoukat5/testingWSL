...
if (isset($_POST['checkconvertStatus'])) {
	...
	if ($universityStatus!="all") {
		$whereCondition .= " AND icp.italy_university_name='".$universityStatus."' ";
	}
