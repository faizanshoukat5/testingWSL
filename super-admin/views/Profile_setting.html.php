...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="profile-user-box">
            <div class="row">
                <div class="col-sm-6">
                    <span class="float-left mr-3"><img src="../images/<?php echo $_SESSION['user_image'];?>" alt="" class="avatar-xl rounded-circle"></span>
        ...
        <div class="col-lg-12">
            ...
            <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="form-group file-upload col-md-12">
                                        <div class="image-upload-wrap">
                                             <input class="file-upload-input user-image" name="userImage" type='file' onchange="readImageURL(this);" accept="image/*" />
                                            <?php 
                                        ...
                                        <button class="btn btn-custom col-md-12" type="button" onclick="$('.user-image').trigger('click')">Upload Image</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-pane" id="companyInfo">
                    <?php foreach ($companyInfo_ex as $row){?>
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="form-group col-md-9">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input value="<?php echo $row['com_name'] ;?>" type="text" class="form-control" name="companyname" required="required" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Company Phone <span class="text-danger">*</span></label>
                                        <input value="<?php echo $row['com_phone'] ;?>" type="number" class="form-control" name="companyphone" required="required" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Company Email <span class="text-danger">*</span></label>
                                        <input value="<?php echo $row['com_email'] ;?>" type="email" class="form-control" name="companyemail" required="required" >
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label >Company Address </label>
                                        <textarea class="form-control" name="companyaddress" required="required"><?php echo $row['com_address'] ;?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <div class="row">
                                    <div class="form-group file-upload col-md-12">
                                        <div class="image-upload-wrap">
                                            <input class="file-upload-input company-logo" name="logo_photo" type='file' onchange="readURL(this);" accept="image/*" />
                                            <?php 
                                                echo "<img class=''  src='../images/".$row['com_logo']."' alt='your image' height='150px'/>";
                                            ?>
                                        </div>
                                        <div class="file-upload-content">
                                            <img class='file-upload-image' src="#" alt='your image' height='150px'/>";
                                        </div>
                                        <button class="btn btn-custom col-md-12" type="button" onclick="$('.company-logo').trigger('click')">Upload Logo</button>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                            <div class="form-group col-md-12">
                                <button type="submit" name="updateCompany" class="btn btn-custom"><i class="mdi mdi-upload"></i> Update</button>
                            </div>
                        </div>
                    </form>
                </div>
