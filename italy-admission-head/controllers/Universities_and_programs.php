...
if(isset($_POST['subAddProgram'])) {
	...
	$insertPro = "INSERT INTO `italy_add_programs".$_SESSION['dbNo']."` (`italy_ap_uni_name`, `italy_ap_degree`, `italy_ap_note`, `italy_active_status`, `italy_ap_intake`, `close`, `status`, `entry_by`) VALUES ('".$uniName."', '".$uniDegree."', '".$programNote."', '1', '2025', '1', '1', '".$_SESSION['user_id']."')";
...
if(isset($_POST['updAddProgram'])) {
	...
	$insertPro = "UPDATE italy_add_programs".$_SESSION['dbNo']." SET italy_ap_uni_name='".$uniName."', italy_ap_degree='".$uniDegree."', italy_ap_note='".$programNote."' WHERE italy_ap_id='".$updateID."'";
	$insertPro_ex = mysqli_query($con,$insertPro);
