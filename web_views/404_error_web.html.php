...
<head>
	<meta charset="utf-8" />
	<title>404 Error | WSL Consultants </title>
					...
					<div class="card mb-0">
						<div class="card-body p-4">
							<div class="text-center account-box">
								<div class="mb-4 mt-4">
									<div class="text-center">
										<svg id="Layer_1" class="svg-computer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 424.2 424.2">
											<style>
												.st0{fill:none;stroke:#3461ff;stroke-width:5;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
											</style>
											<g id="Layer_2">
								...
								<h3 class="text-primary">We’re Currently Performing Maintenance</h3>
								<h4 class="text-muted mb-0">Software is temporarily unavailable as we work on updates and improvements to enhance your experience.</h4>
								<h6 class="text-muted mb-0">Thank you for your patience—stay tuned for exciting changes!</h6>
							</div>
						</div>
					</div> <!-- end card-body -->
				</div> <!-- end card -->
