...
function ($) {
    ...
    $(document).ready(function() {
    // Function to scroll the sidebar to the active item
        function scrollToActive() {
            var $active = $('#sidebar-menu .mm-active .active');
            if ($active.length) {
                var activeItemOffset = $active.offset().top;
                var sidebarOffset = $('.slimscroll-menu').offset().top;
                var scrollPos = activeItemOffset - sidebarOffset;
                // Ensure slimscroll-menu is initialized
                var $slimscrollMenu = $('.slimscroll-menu');
                if (scrollPos > 100) {
                    // Use slimScroll API to set the scroll position
                    $('.slimscroll-menu').animate({scrollTop: scrollPos - 230}, 'slow');
                    $slimscrollMenu.slimScroll({ scrollTo: scrollPos - 230 + 'px' });
                }
            }
        }
