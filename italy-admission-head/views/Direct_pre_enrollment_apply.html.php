...
$assignPreTo = $row['italy_pre_assign_to'];
...
$summaryStatus = $row['italy_pre_summary_status'];
$summaryScreenshot = $row['italy_pre_summary_screenshot'];
$summaryNote = $row['italy_pre_summary_note'];
$summaryDate = $row['italy_pre_summary_date'];
	...
	<div class="card-body">
		<div class="row">
			...
			<div class="form-group col-md-4">
				<div class="alert bg-dark text-warning">
					<?php
					$assignId = ($assignPreTo != '0') ? $assignPreTo : $assignTo;
					$wtName = '';
					$wt_query = "SELECT CONCAT(fname, ' ', lname) AS wtName FROM wt_users WHERE status='1' AND close='1' AND wt_id='$assignId'";
			...
			<div class="form-group col-md-8">
				...
				<button type="button" class="btn btn-success btn-sm float-right mt-1 mr-1" data-toggle="tooltip" data-placement="top" title="Acceptance Letter" onclick="acceptanceLetter(<?php echo $programAppliedID; ?>);"> <i class="mdi mdi-eye"></i> Acceptance Letter</button>
				<?php 
				...
				<div class="row">
						...
						<fieldset class="scheduler-border-team">
							...
							<h4>
								...
								<div class="radio radio-success form-check-inline">
									<input type="radio" id="yesIDStep1" value="1" disabled="" name="radioStep1" onclick="firstYesStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep1 == 1) ? 'checked' : '';?>>

									<label for="yesIDStep1"> Yes </label>
								</div>
								<div class="radio radio-danger form-check-inline">
									<input type="radio" id="noIDStep1" value="2" disabled="" name="radioStep1" onclick="firstNoStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep1 == 2) ? 'checked' : '';?>>
					...
					<div class="col-md-12">
						<fieldset class="scheduler-border-team">
							...
							<h4>
								...
								<div class="radio radio-success form-check-inline">
									<input type="radio" id="yesIDStep2" value="1" disabled="" name="radioStep2" onclick="secYesStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep2 == 1) ? 'checked' : '';?>>

									<label for="yesIDStep2"> Yes </label>
								</div>
								<div class="radio radio-danger form-check-inline">
									<input type="radio" id="noIDStep2" value="2" disabled="" name="radioStep2" onclick="secNoStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep2 == 2) ? 'checked' : '';?>>
							...
							<form action="" method="POST" enctype="multipart/form-data" class="parsley-examples">
								...
								<div class="row">
									<div class="form-group col-md-3">
										...
										<input type="text" name="preUsername" class="form-control" required="required" autocomplete="off" value="<?php echo $preUsername;?>" readonly="">
									</div>
									<div class="form-group col-md-3">
										<label class="form-label">Password <span class="text-danger">*</span></label>
										<input type="text" name="prePassword" class="form-control" required="required" autocomplete="off" value="<?php echo $prePassword;?>" readonly="">
									</div>
									<div class="form-group col-md-3">
										<label class="form-label">Link <span class="text-danger">*</span></label>
										<input type="text" name="preLink" class="form-control" required="required" autocomplete="off" value="<?php echo $preLink;?>" readonly="">
									</div>
									<div class="form-group col-md-3">
										<label class="form-label">ScreenShot</label>
										<input type="file" name="preScreenShot" class="form-control" autocomplete="off" readonly="">
										<?php 
					...
					<div class="col-md-12">
						<fieldset class="scheduler-border-team">
							...
							<h4>
								...
								<div class="radio radio-success form-check-inline">
									<input type="radio" id="yesIDStep3" value="1" disabled="" name="radioStep3" onclick="thirdYesStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep3 == 1) ? 'checked' : '';?>>

									<label for="yesIDStep3"> Yes </label>
								</div>
								<div class="radio radio-danger form-check-inline">
									<input type="radio" id="noIDStep3" value="2" disabled="" name="radioStep3" onclick="thirdNoStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep3 == 2) ? 'checked' : '';?>>
							...
							<form action="" method="POST" enctype="multipart/form-data" class="parsley-examples">
								...
								<div class="row">
									<div class="form-group col-md-3">
										<label class="form-label">Username / Email <span class="text-danger">*</span></label>
										<input type="text" name="preUpUsername" class="form-control" required="required" autocomplete="off" value="<?php echo $preUpUsername;?>" readonly="">
									</div>
									<div class="form-group col-md-3">
										<label class="form-label">Updated Password <span class="text-danger">*</span></label>
										<input type="text" name="preUpPassword" class="form-control" required="required" autocomplete="off" value="<?php echo $preUpPassword;?>" readonly="">
									</div>
									<div class="form-group col-md-3">
										<label class="form-label">Link <span class="text-danger">*</span></label>
										<input type="text" name="preUpLink" class="form-control" required="required" autocomplete="off" value="<?php echo $preUpLink;?>" readonly="">
									</div>
									<div class="form-group col-md-3">
										<label class="form-label">Updated ScreenShot</label>
										<input type="file" name="preUpScreenShot" class="form-control" autocomplete="off" readonly="">
										<?php 
					...
					<div class="col-md-12">
						<fieldset class="scheduler-border-team">
							...
							<h4>
								<span id="step4Title" style=" <?php if ($preStep4==1){?> color: green; <?php }elseif ($preStep4==2) { ?> color: red;<?php } ?>"><b>Fill out the pre Form</b></span> &nbsp;&nbsp;&nbsp;&nbsp;
								<div class="radio radio-success form-check-inline">
									<input type="radio" id="yesIDStep4" value="1" disabled="" name="radioStep4" onclick="fourYesStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep4 == 1) ? 'checked' : '';?>>

									<label for="yesIDStep4"> Yes </label>
								</div>
								<div class="radio radio-danger form-check-inline">
									<input type="radio" id="noIDStep4" value="2" disabled="" name="radioStep4" onclick="fourNoStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep4 == 2) ? 'checked' : '';?>>
					...
					<div class="col-md-12">
						<fieldset class="scheduler-border-team">
							...
							<h4>
								<span style="<?php if ($preokScreenshot!=''){?> color: green; <?php }elseif ($preokScreenshot=='') { ?> color: red;<?php } ?>"> <b>Application Rechecked by Client and Submit by Team</b> </span>
							</h4>
							...
							<ul class="nav nav-tabs">
								...
								<li class="nav-item">
									<a href="#uploadScreenshot" data-toggle="tab" aria-expanded="true" class="nav-link active">
										...
										<span class="d-none d-sm-block text-warning">Application Rechecked by Client and Submit by Team
										<?php if ($preinfoClientStatus=='0' && $preappliedStatus=='5') { ?>
								...
								<li class="nav-item">
									<a href="#uploadScreenshot" data-toggle="tab" aria-expanded="true" class="nav-link navSuccess active">
										<span class="d-block d-sm-none"><i class="mdi mdi-home-variant"></i></span>
										<span class="d-none d-sm-block text-success">Application Rechecked by Client and Submit by Team</span>
									</a>
								</li>
								<?php } ?>
							</ul>
					...
					<div class="col-md-12">
						<fieldset class="scheduler-border-team">
							...
							<h4>
								...
								<div class="radio radio-success form-check-inline">
									<input type="radio" id="yesIDStep6" value="1" disabled="" name="radioStep6" onclick="sixYesStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep6 == 1) ? 'checked' : '';?>>
									<label for="yesIDStep6"> Yes </label>
								</div>
								<div class="radio radio-danger form-check-inline">
									<input type="radio" id="noIDStep6" value="2" disabled="" name="radioStep6" onclick="sixNoStep(<?php echo $programAppliedID;?>);" <?php echo ($preStep6 == 2) ? 'checked' : '';?>>
									<label for="noIDStep6"> No </label>
								</div>
								<?php if (($preinfoClientStatus=='3' || $preinfoClientStatus=='5') && $preappliedStatus=='7') {?>
					...
					<div class="col-md-12">
						<fieldset class="scheduler-border-head">
							...
							<h4><span style="<?php if ($preproofScreenshot!=''){?> color: green; <?php }elseif ($preproofScreenshot=='') { ?> color: red;<?php } ?>"><b> Inform the client that the pre-enrollment application has been submitted</b></span></h4>
							...
							<form id="formPreProof" enctype="multipart/form-data" class="parsley-examples">
								<input type="hidden" name="updateProgramID" value="<?php echo $programAppliedID;?>">
								<div class="row">
									<div class="col-md-12">
										<div class="row">
									...
									<div class="form-group col-md-12">
										...
										<textarea class="form-control" name="preproofNote"><?php echo $preproofNote;?></textarea>
									</div>
									<div class="form-group col-md-6">
										<div class="agreement-container" data-agreement-id="5">
											...
											<input type="file" name="preproofScreenshot[]" id="uploadedFiles5" class="form-control" required="required" multiple style="display: none;">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="float-right">
											<button class="btn btn-custom" type="button" name="subpreProof" onclick="saveDataForm('formPreProof', 'subpreProof')" id="subpreProof" <?php echo ($programNo1Status!='') ? 'disabled' : '';?>><i class="mdi mdi-upload"></i> Submit </button>
										</div>
									</div>
								</div>
							</form>
					...
					<div class="col-md-12">
						<fieldset class="scheduler-border-team">
							<legend class="scheduler-border-team">
								Step: 08 <span class="text-purple">* (Processing Team & Admisssion Head Task)</span>
							</legend>
							...
							<ul class="nav nav-tabs">
								...
								<?php } ?>
								<?php if ($programNo1Status=='Acceptance' || $summaryStatus=='Received'){ ?>
								<li class="nav-item">
								...
								<?php } ?>
								<?php if ($summaryStatus=='Received'){ ?>
								<li class="nav-item">
									<a href="#Summary" data-toggle="tab" aria-expanded="true" class="nav-link navSuccess">
										<span class="d-block d-sm-none"><i class="mdi mdi-home-variant"></i></span>
										<span class="d-none d-sm-block text-success">Summary</span>
									</a>
								</li>
								<?php }elseif ($summaryStatus=='Rejection'){?>
								<li class="nav-item">
									<a href="#Summary" data-toggle="tab" aria-expanded="true" class="nav-link">
										<span class="d-block d-sm-none"><i class="mdi mdi-home-variant"></i></span>
										<span class="d-none d-sm-block text-danger">Summary</span>
									</a>
								</li>
								<?php }else{ ?>
								<li class="nav-item">
									<a href="#Summary" data-toggle="tab" aria-expanded="true" class="nav-link">
										<span class="d-block d-sm-none"><i class="mdi mdi-home-variant"></i></span>
										<span class="d-none d-sm-block text-warning">Summary</span>
									</a>
								</li>
								<?php } ?>
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="admissionDecision">
									<div class="row">
										...
										<div class="col-md-12">
											<form id="formPrePro1" enctype="multipart/form-data" class="parsley-examples">
											<input type="hidden" name="updateProgramID" value="<?php echo $programAppliedID;?>">
												<div class="row">
													<div class="col-md-12">
													...
													<div class="form-group col-md-5">
														<div class="agreement-container" data-agreement-id="6">
															...
															<input type="file" name="programNo1Screenshot[]" id="uploadedFiles6" class="form-control" required="required" multiple style="display: none;">
															<div class="preview"></div>
														</div>
													</div>
													<div class="form-group col-md-4">
													...
													<div class="col-md-12">
														<div class="float-right">
															<button class="btn btn-custom" type="button" name="submitProgram1" onclick="saveDataForm('formPrePro1', 'submitProgram1')" id="submitProgram1"><i class="mdi mdi-upload"></i> Update </button>
														</div>
													</div>
												</div>
											</form>
									...
									<div class="row">
										<div class="col-md-12">
											<table class="table table-bordered">
												...
												<tbody>
													<tr>
														<td><?php echo $summaryStatus;?></td>
														<td class="breakTD"><?php 
														$fileMulti = explode(',', $summaryScreenshot);
														foreach ($fileMulti as $fileName) {
														?>
														<a href="../payagreements/<?php echo $fileName;?>" target="blank"><?php echo $fileName;?></a><br>
														<?php } ?></td>
														<td class="breakTD"><?php echo $summaryNote;?></td>
														<td><?php if($summaryDate=='0000-00-00'){}else{ echo $summaryDate; }?></td>
													</tr>
												</tbody>
											</table>
										</div>
										...
										<div class="form-group col-md-12">
											<form id="formPreSummary" enctype="multipart/form-data" class="parsley-examples">
											<input type="hidden" name="updateProgramID" value="<?php echo $programAppliedID;?>">
												<div class="row">
													<div class="col-md-4">
														<label>Summary Status <span class="text-danger">*</span></label> <br>
														<div class="radio radio-success form-check-inline">
															<input type="radio" id="summaryReceived" value="Received" name="summaryStatus" required="required">
															<label for="summaryReceived"> Summary Received </label>
														</div>
														<div class="radio radio-danger form-check-inline">
															<input type="radio" id="summaryReject" value="Rejection" name="summaryStatus" required="required">
															<label for="summaryReject"> Summary Rejection </label>
														</div>
													</div>
													<div class="form-group col-md-4">
														<div class="agreement-container" data-agreement-id="17">
															<label class="form-label">Upload Summary <span class="text-danger">* (Select Multi Files)</span></label>
															<div class="d-flex justify-content-center">
																<input type="file" class="fileInput cust-file-input text-white" name="" multiple data-toggle="tooltip" data-placement="top" title="Select or Drag Files Here">
																<input type="text" class="form-control pasteInput" placeholder="Paste Image..."  autocomplete="off" style="width: 70%;">
															</div>
															<input type="file" name="summaryScreenshot[]" id="uploadedFiles17" required="required" class="form-control" multiple style="display: none;">
															<div class="preview"></div>
														</div>
													</div>
													<div class="form-group col-md-4">
														<label class="form-label">Date <span class="text-danger">*</span></label>
														<input type="date" name="summaryDate" class="form-control" autocomplete="off" required="required" value="<?php echo date('Y-m-d');?>">
													</div>
													<div class="form-group col-md-12">
														<label class="form-label">Note </label>
														<textarea class="form-control" name="summaryNote"></textarea>
													</div>
													<div class="col-md-12">
														<div class="float-right">
															<button class="btn btn-custom" type="button" name="submitSummary" onclick="saveDataForm('formPreSummary', 'submitSummary')" id="submitSummary"><i class="mdi mdi-upload"></i> Update </button>
														</div>
													</div>
												</div>
											</form>
