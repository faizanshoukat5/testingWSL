...
<div class="card">
	<div class="card-body">
		...
		<!-- Program Modal -->
		<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="programModalClient" style="display: none;">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						<h4 class="modal-title" id="myLargeModalLabel">Add Program</h4>
					</div>
					<div class="modal-body programModalClient">
...
<?php
$ajaxUrl = "models/viewProgramNotConfirmModel.php";
...
<script type="text/javascript">
	...
	function programClients(idclient) {
		...
		$.ajax({
			...
			data:'clientConfirmProgram='+idclient,
			success: function(data){
				$(".programModalClient").html(data);
				$("#programModalClient").modal('show');
			}
		});
	};
</script>