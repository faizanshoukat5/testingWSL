...
$selectQuery = "SELECT wt_id, fname, lname FROM wt_users WHERE status='1' AND close='1' AND type='italy admission team' AND wt_id='".$wtID."' ";
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="alert alert-primary">
					<h5><?php echo ucwords($dataRow['fname']." ".$dataRow['lname']);?> <span class="float-right">Total Applications: <b><?php echo number_format($countTotalAssign);?></b> </span></h5>
				</div>
			</div>
		</div>
