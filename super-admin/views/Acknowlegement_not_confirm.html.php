...
<div class="card">
	<div class="card-body">
		...
		<!-- Ack confirm form client -->
		<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="ackModalClient" style="display: none;">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						<h4 class="modal-title" id="myLargeModalLabel">Acknowledgement Confirm</h4>
					</div>
					<div class="modal-body ackModalClient">
...
<?php
$ajaxUrl = "models/viewAckNotConfirmModel.php";
include ('components/AllFiltersFunction.php');
?>
<script type="text/javascript">
	// Ack confirm from the clients
	function ackConfirm(idack) {
		var idack = idack;
		// alert(idack);
		$.ajax({
			type: "POST",
			url: "models/accountPayState.php",
			data:'ackConfirm='+idack,
			success: function(data){
				// alert(data);
				$(".ackModalClient").html(data);
				$("#ackModalClient").modal('show');
			}
		});
	};
</script>
