	...
	<div class="card-body">
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<?php 
					$uniDetails = "SELECT aus_uni_deadline_link FROM austria_add_universities".$_SESSION['dbNo']." WHERE status='1' AND close='1' AND aus_uni_degree='master' AND aus_uni_name='".$uniName."' ";
			...
			<div class="row">
				<div class="col-md-7">
					<div class="row">
						...
						<?php 
						$selectQuery = "SELECT aus_opening_date, aus_closing_date, aus_note FROM austria_university_dates WHERE status='1' AND close='1' AND aus_university_name ='$uniName' AND aus_degree_name='master' ORDER BY aus_dates_id DESC LIMIT 1";
				...
				<div class="col-md-5">
					<div class="float-left">
						<?php 
						$selectQuery = "SELECT aus_uni_cgpa FROM austria_university_cgpa WHERE status='1' AND close='1' AND aus_cgpa_uni_name ='$uniName' AND aus_cgpa_uni_degree='master' ORDER BY aus_cgpa_uni_id DESC LIMIT 1";
						$result = mysqli_query($con, $selectQuery);
