...
if (isset($_POST['checkuniName'])) {
	...
	if ($assignPrograms!="all") {
		...
		if ($assignPrograms=='Assign But Not Approved') {
			...
			if($uniName=='University of Campania (UC)' || $uniName=='University of Napoli Fedrico II (UNP)' || $uniName=='University of Palermo (PLM)' || $uniName=='University of Perugia (UPG)' || $uniName=='University of Siena (US)' || $uniName=='University of Turin (TU)' || $uniName=='University of Salento (UST)' ){
				$proofScreen = "icp.italy_pre_info_screenshot='' ";
			}
			if($uniName=='University of Milano Bicocca (MLB)'){
				$proofScreen = "icp.italy_tolc_client_info_screenshot!='' ";
			}
			$whereCondition .= " AND icp.italy_assign_status='1' AND $proofScreen ";
		}
		if ($assignPrograms=='Assign and Applied') {
			...
			if($uniName=='University of Milano Bicocca (MLB)'){
				$proofAppliedScreen = "icp.italy_tolc_fee_proof_screenshot!='' ";
			}
			$whereCondition .= " AND icp.italy_assign_status='1' AND $proofAppliedScreen ";
		}
		if ($assignPrograms=='Assign but Not Paid Fee') {
			if($uniName=='CaFoscari University of Venice (FV)' || $uniName=='University of Padua (PDU)' || $uniName=='University of Pavia (PV)' || $uniName=='University of Siena (US)' || $uniName=='University of Turin (TU)' || $uniName=='University of Trieste (TR)' || $uniName=='University of Bari (UB)'){
				$notFeeScreen = "icp.italy_fee_paid_client='' ";
			}
			if($uniName=='Sapienza University of Rome (SPU)' || $uniName=='Universita Politecnica Delle Marche (MR)' || $uniName=='University of Marche (MR)' || $uniName=='University of Bologna (UBN)' || $uniName=='University of Messina (UM)' || $uniName=='University of Palermo (PLM)' || $uniName=='University of Pisa (UP)' || $uniName=='University of Verona (VN)' || $uniName=='University of Trento (TRN)' || $uniName=='University of Tuscia (TS02)' || $uniName=='University of Tuscia (TS)' || $uniName=='University of Laquia (LAQ01)' || $uniName=='University of Camerino (UC)' || $uniName=='University of Camerino (CM)' || $uniName=='University of Cassino (CS)' || $uniName=='University of Parma (PRM)' || $uniName=='Tor Vergata University of Rome (TVR)' || $uniName=='University of Tor Vergata (TVR)' || $uniName=='Bozen-Bolzano (BZB)' || $uniName=='University of Milan (UML)' || $uniName=='University of Genova (UG)'){
				$notFeeScreen = "icp.italy_direct_fee_paid_client='' ";
			}
			if($uniName=='University of Campania (UC)' || $uniName=='University of Napoli Fedrico II (UNP)' || $uniName=='University of Palermo (PLM)' || $uniName=='University of Perugia (UPG)' || $uniName=='University of Siena (US)' || $uniName=='University of Salento (UST)'){
		...
		if ($assignPrograms=='Fee Paid but Not Approved') {
			if($uniName=='CaFoscari University of Venice (FV)' || $uniName=='University of Padua (PDU)' || $uniName=='University of Pavia (PV)' || $uniName=='University of Siena (US)' || $uniName=='University of Turin (TU)' || $uniName=='University of Trieste (TR)' || $uniName=='University of Bari (UB)'){
		...
		if ($assignPrograms=='One Time Account Create') {
			...
			if($uniName=='University of Campania (UC)' || $uniName=='University of Napoli Fedrico II (UNP)' || $uniName=='University of Perugia (UPG)' || $uniName=='University of Foggia (FG)' || $uniName=='University of Salerno (SL)' || $uniName=='University of Salento (UST)'){
				$assign = "icp.italy_pre_username!='' AND icp.italy_pre_info_screenshot='' ";
			}
			if($uniName=='University of Milano Bicocca (MLB)'){
				$assign = "icp.italy_tolc_account_username!='' AND icp.italy_tolc_client_info_screenshot='' ";
			}
