		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="float-right">
					<?php 
					$uniDetails = "SELECT italy_uni_deadline_link FROM italy_add_universities".$_SESSION['dbNo']." WHERE status='1' AND close='1' AND italy_uni_degree='bachelor' AND italy_uni_name='".$uniName."' ";
			...
			<div class="row">
				<div class="col-md-6">
					<div class="row">
						...
						<?php 
						$selectQuery = "SELECT italy_opening_date, italy_closing_date, italy_note FROM italy_university_dates WHERE status='1' AND close='1' AND italy_university_name='$uniName' AND italy_degree_name='bachelor' ORDER BY italy_dates_id DESC LIMIT 1";
				...
				<div class="col-md-6">
					<div class="float-left">
						<?php 
						$selectQuery = "SELECT italy_uni_cgpa FROM italy_university_cgpa WHERE status='1' AND close='1' AND italy_cgpa_uni_name ='$uniName' AND italy_cgpa_uni_degree='bachelor' ORDER BY italy_cgpa_uni_id DESC LIMIT 1";
						$result = mysqli_query($con, $selectQuery);
