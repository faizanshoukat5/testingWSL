...
if (isset($_POST['checkuniName'])) {
	...
	if ($assignPrograms!="all") {
		...
		if ($assignPrograms=='Assign but Not Paid Fee') {
			...
			if($uniName=='University of Bologna (UBN)'){
				$notFeeScreen = "icp.italy_direct_fee_paid_client='' AND icp.italy_direct_final_step='0' ";
			}
			if($uniName=='University of Campania (UC)' || $uniName=='University of Napoli Fedrico II (UNP)' || $uniName=='University of Perugia (UPG)' || $uniName=='University of Salerno (SL)' || $uniName=='Universita Del Piemonte Orientale (UDPO)' || $uniName=='University of Salento (UST)'){
