...
if (isset($_POST['checkwtID'])) {
	...
	$select = "SELECT * FROM clients{$_SESSION['dbNo']} cl JOIN italy_clients_programs{$_SESSION['dbNo']} icp ON cl.client_id=icp.italy_clients_id  WHERE icp.close='1' AND icp.status='1' AND icp.italy_change_program_status='0' AND cl.close='1' AND cl.status='1' AND cl.case_status='0' AND cl.change_status='0' AND cl.client_document_status='1' AND cl.client_pro_confirm_status='1' AND cl.client_pay_confirm_status='1' AND cl.ack_confirm_status='1' AND cl.client_country='$country' AND icp.italy_sops_assign_to='$userId' ORDER BY client_id DESC";
	$select_ex = mysqli_query($con, $select);
	$countTotalSOPAssign = mysqli_num_rows($select_ex);

	$select = "SELECT * FROM clients{$_SESSION['dbNo']} cl JOIN italy_clients_programs{$_SESSION['dbNo']} icp ON cl.client_id=icp.italy_clients_id  WHERE icp.close='1' AND icp.status='1' AND icp.italy_change_program_status='0' AND cl.close='1' AND cl.status='1' AND cl.case_status='0' AND cl.change_status='0' AND cl.client_document_status='1' AND cl.client_pro_confirm_status='1' AND cl.client_pay_confirm_status='1' AND cl.ack_confirm_status='1' AND cl.client_country='$country' AND icp.italy_sops_assign_to='$userId' AND (icp.italy_sops_status='1' || icp.italy_sops_status='2' || icp.italy_sops_status='3' || icp.italy_sops_status='4') ORDER BY client_id DESC";
	$select_ex = mysqli_query($con, $select);
	$countTotalSOPWritten = mysqli_num_rows($select_ex);

	$select = "SELECT * FROM clients{$_SESSION['dbNo']} cl JOIN italy_clients_programs{$_SESSION['dbNo']} icp ON cl.client_id=icp.italy_clients_id  WHERE icp.close='1' AND icp.status='1' AND icp.italy_change_program_status='0' AND cl.close='1' AND cl.status='1' AND cl.case_status='0' AND cl.change_status='0' AND cl.client_document_status='1' AND cl.client_pro_confirm_status='1' AND cl.client_pay_confirm_status='1' AND cl.ack_confirm_status='1' AND cl.client_country='$country' AND icp.italy_sops_assign_to='$userId' AND icp.italy_sops_status='0' ORDER BY client_id DESC";
	$select_ex = mysqli_query($con, $select);
		...
		<div class="card-box widget-box-two widget-two-custom" style="background: linear-gradient(180deg, #000428, #004e92);">
			<div class="media">
				...
				<div class="wigdet-two-content media-body">
					<a href="#">
						<p class="m-0 font-weight-medium text-truncate text-white" title="Statistics">Total Italy Clients</p>
						<h3 class="font-weight-medium my-2 text-white"><span data-plugin="counterup"><?php echo number_format($countTotalItaly); ?></span></h3>
	...
	<div class="col-xl-4 col-sm-6">
		<div class="card-box widget-box-two widget-two-custom" style="background: linear-gradient(180deg, #000428, #004e92);">
			<div class="media">
				...
				<div class="wigdet-two-content media-body">
					<a href="#">
						<p class="m-0 font-weight-medium text-truncate text-white" title="Statistics">Bachelor in Italy</p>
						<h3 class="font-weight-medium my-2 text-white"> <span data-plugin="counterup"><?php echo number_format($countBachelorItaly) ?></span></h3>
						<p class="m-0 text-white">Total</p>
					</a>
				</div>
			</div>
	...
	<div class="col-xl-4 col-sm-6">
		<div class="card-box widget-box-two widget-two-custom" style="background: linear-gradient(180deg, #000428, #004e92);">
			<div class="media">
				...
				<div class="wigdet-two-content media-body">
					<a href="#">
						<p class="m-0 font-weight-medium text-truncate text-white" title="Statistics">Master in Italy</p>
						<h3 class="font-weight-medium my-2 text-white"><span data-plugin="counterup"><?php echo number_format($countMasterItaly) ?></span></h3>
						<p class="m-0 text-white">Total</p>
					</a>
				</div>
			</div>
