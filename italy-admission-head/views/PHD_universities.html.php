		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="float-right">
					<?php 
					$uniDetails = "SELECT italy_uni_deadline_link FROM italy_add_universities".$_SESSION['dbNo']." WHERE status='1' AND close='1' AND italy_uni_degree='phd' AND italy_uni_name='".$uniName."' ";
			...
			<input type="hidden" name="degreeName" value="phd" id="degreeName">
...
<?php
$ajaxUrl = "models/viewPHDClientsModel.php";
