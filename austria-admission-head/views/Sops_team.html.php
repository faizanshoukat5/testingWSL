...
$selectQuery = "SELECT wt_id, fname, lname FROM wt_users WHERE status='1' AND close='1' AND type='austria university sop' AND wt_id='".$wtID."' ";
...
<script type="text/javascript">
	...
	function viewClientsFilter(page) {
		...
		if (convertStatus!=='all' || clientCountry!=='all' || clientDegree!=='all' || startDate || endDate ) {
			// Only set parameters if they are not 'all'
