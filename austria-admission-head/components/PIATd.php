<?php 
	...
	$addVerifi = ($row['client_country'] == 'austria') ? 'Payable on getting Verification Appointment' : (($row['client_country'] == 'czech republic') ? 'Payable After Admission Confirmation' : '');
	$rpVisa = ($row['client_country'] == 'austria') ? 'Payable on RP Approval' : (($row['client_country'] == 'czech republic') ? 'Payable on Visa Approval' : '');
